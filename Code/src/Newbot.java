...
public class Newbot extends Swagbot {//rename Swagbot extends Localisingbot
   ...
   public Newbot(final SensorPort sonicPort, final SensorPort colourPort) {
      super(sonicPort,colourPort);
