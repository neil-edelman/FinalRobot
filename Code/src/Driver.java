...
//           count++;
   ...
   /** The robot localises at (30.48,30.48) in our coordinate system with the origin at the edge of the field regardless of the corner it is placed in.The 
   points passed to the robot through bluetooth are transformed to our coordinate system taking into account the corner the robot is placed in.
   */
   ...
   /**The robot creates a thread to continually monitor the escape button and allow for exiting the program at any point in the code after this method is invoked.
   */
   private static void monitorForExit() {
	...
	/** Wait for the robot's status to be idle (eg completed a turn, or travelled to a
	 destination).Using this after a command such as turnTo or findBlocks allows the program to wait for the method to execute.
	 @author Alex */
   ...
   /** unit tests for robot code, 
   localise: working correctly | desired function: rotates counterclockwise and updates odometer
   turnTo/travelTo: works | desired function:
         turn left, turn right
         travel to the first cross of vertical and horizontal lines
         face 90 (straight).
   findBlocks: working correctly | not tested, too long
   when you complete a function write a test method
